...
startKey
   : KEY IS? (NOT? (GREATER THAN? | MORETHANCHAR | LESS THAN? | LESSTHANCHAR) | EQUALCHAR | EQUAL TO? | GREATER THAN? OR EQUAL TO? | MORETHANOREQUAL | LESS THAN? OR EQUAL TO? | LESSTHANOREQUAL) qualifiedDataName
   ;
...
cobolWord
   ...
   | CAPABLE | CCSVERSION | CHANGED | CHANNEL | CLOB | CLOSE_DISPOSITION | COBOL | COMMITMENT | CONTROL_POINT | CONVENTION | CRUNCH | CURSOR | CYCLE
